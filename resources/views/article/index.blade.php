        ...
        <tbody role="alert" aria-live="polite" aria-relevant="all">
	        @foreach($data as $k=>$v)
	          ...
	          ">
	            ...
	            <td class=" ">
	            <!-- 修改和删除的连接 -->
	            <a href="/admins/article/edit?id={{$v['id']}}" style='color:black;font-size:20px'><i class="icon-pencil-2"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
	            <a href="/admins/article/delete?id={{$v['id']}}" style='color:black;font-size:20px'><i class="icon-trash"></i></a>
	            </td>
	          </tr>
	        @endforeach
        </tbody>
